...
class MultiAgentSing_fullobs(MultiAgentEnv):
    ...
    def reset(self):
        ...
        # self.miss1_list = list()
        # self.miss2_list = list()
        # self.drink1_list = list()
        # self.poke1_list = list()
        # self.drink2_list = list()
        # self.poke2_list = list()
        # How many timesteps have we done in this episode.
        self.timesteps = 0
    ...
    def step(self, action: dict):
        ...
        info = {
            ...
            # "miss1_list":self.miss1_list,
            # "miss2_list":self.miss2_list,
            #  "drink1_list":self.drink1_list,
            #  "poke1_list":self.poke1_list,
            #  "drink2_list":self.drink2_list,
            #  "poke2_list":self.poke2_list},
        }
        return obs, rewards, dones, info  # <- info dict (not needed here).
